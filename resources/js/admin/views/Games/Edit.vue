                            ...
                            <div v-for="(language, key) in languages"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <text-area
                                            :field="fields.rules"
                                            @update:modelValue="item.translations[language.id].rules = $event"
                                            :modelValue="item.translations[language.id].rules"
                                        />
                                    </div>
                                    <div class="col">
                                        <text-input
                    ...
                    <div
                        ...
                        <div class="form-group">
                            <select-list
                                ...
                                @update:modelValue="item.category_id = $event"
                                :modelValue="item.category_id"
                            />
                        </div>
                        <div class="form-group">
                            <file-input-image
                        ...
                        <div class="form-group">
                            <file-input-document
                                @update:modelValue="item.game = $event"
                                :modelValue="item.game"
                            />
                        </div>
    ...
    computed: {
        ...
        fields(){
            ...
            return {
                ...
                category: {title : this.$t("Category"), er : "", message : "", options : this.categories},
                rules: {title : this.$t("Rules"), er : "", message : ""},
